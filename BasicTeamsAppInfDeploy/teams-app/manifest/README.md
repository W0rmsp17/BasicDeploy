...
The manifest references `outline.png` and `color.png`. Add those icons before uploading the app package through Teams Developer Portal or Teams admin center.
