module "runtime" {
  ...
  environment_name    = "cholbing-dev"
  location            = var.location
  graph_tenant_id     = var.graph_tenant_id
  graph_client_id     = var.graph_client_id
  default_user_domain = "CholbingDevoutlook.onmicrosoft.com"
  ...
  tags = {
    ...
    environment  = "cholbing-dev"
    targetTenant = "CholbingDevoutlook.onmicrosoft.com"
    mspTenant    = "plutonix.onmicrosoft.com"
  }
}
